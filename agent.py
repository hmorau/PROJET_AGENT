...
def main(): 
    ...
    with project_client:
        ...
        agent = project_client.agents.create_agent(
            ...
            - query_database(sql_query: str) -> DataFrame : exécute une requête SQL et retourne les résultats sous forme de JSON.
            - get_database_schema() -> dict : récupère le schéma de la base de données (noms des tables et colonnes).
            - create_plot_from_query(sql_query: str, x_column: str, y_column: str, plot_type: str) -> str : exécute une requête SQL et génère un graphique à partir des colonnes spécifiées. Le graphique est sauvegardé sous forme d'image et la fonction retourne le chemin du fichier.
            ...
            4. Si nécessaire, proposez des informations ou des suggestions pour affiner la recherche si les résultats sont trop généraux ou imprécis.
